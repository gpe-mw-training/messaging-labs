package com.redhat.gpe.training.messaging.prioritized;
...
public class SimpleConsumer {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            // Configure Exclusive Consumer and Priority
            String priority = System.getProperty("consumerPriority", "1");
            destination = session.createQueue(destination.getQueueName() + "?consumer.exclusive=true&consumer.priority=" + priority);
