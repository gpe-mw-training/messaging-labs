package com.redhat.gpe.training.messaging.messagegroups;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (int i = 1; i <= NUM_MESSAGES_TO_BE_SENT; i++) {
                ...
                // --------------------------------------------------
                // Create a Message Group to filter messages to
                // different based on Message number. Send odd number
                // messages to one Consumer and even to another
                // --------------------------------------------------
                String msg_code = "Msg_" + (i % 2);
                LOG.info("Sending to Message Group: " + msg_code + " this text: '" + message.getText());
                message.setStringProperty("JMSXGroupID", msg_code);
