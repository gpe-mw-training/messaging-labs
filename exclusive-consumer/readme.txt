This ActiveMQ exercise shows how to create a simple Queue Message Producer and an Exclusive Consumer using
ActiveMQ and Maven.
...
You can also try to restart a client to see what happens then.
